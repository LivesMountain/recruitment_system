...
class CandidateAdmin(admin.ModelAdmin):
    ...
    # 吧export_model_as_csv注册到admin的action
    ...
    # 自定义admin中的model里面的字段分组fields，field中的元组可以使字段展示到一行
    # fieldsets = (
    #     (None,{'fields':(("userid","username","city"),("phone","email"))}),
    #     ('第一轮米那是记录',{'fields':("first_score")})
    # )
    list_display = (
